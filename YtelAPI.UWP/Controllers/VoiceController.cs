...
{
    public partial class VoiceController: BaseController
    {
        ...
        /// </summary>
        internal static VoiceController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// <param name="callSid">Required parameter: The unique identifier for the voice call.</param>
        /// <return>Returns the string response from the API call</return>
        public string CreateViewCallDetails(string callSid)
        {
            Task<string> t = CreateViewCallDetailsAsync(callSid);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="callSid">Required parameter: The unique identifier for the voice call.</param>
        /// <return>Returns the string response from the API call</return>
        public async Task<string> CreateViewCallDetailsAsync(string callSid)
        {
            //the base uri for api requests
            string _baseUri = Configuration.BaseUri;
                ...
                Models.Status1Enum? status = null)
        {
            ...
            var _fields = new List<KeyValuePair<string, Object>>()
            {
                ...
                new KeyValuePair<string, object>( "Method", method ),
                new KeyValuePair<string, object>( "Status", (status.HasValue) ? Models.Status1EnumHelper.ToValue(status.Value) : null )
            };
            //remove null parameters
            _fields = _fields.Where(kvp => kvp.Value != null).ToList();
        ...
        public string CreatePlayAudio(
                ...
                string sayText,
                int? length = null,
                Models.Direction1Enum? direction = null,
                bool? mix = null)
        {
                ...
                bool? mix = null)
        {
            ...
            var _fields = new List<KeyValuePair<string, Object>>()
            {
                ...
                new KeyValuePair<string, object>( "Direction", (direction.HasValue) ? Models.Direction1EnumHelper.ToValue(direction.Value) : null ),
        ...
        /// </summary>
        /// <param name="mfrom">Required parameter: A valid Ytel Voice enabled number (E.164 format) that will be initiating the phone call.</param>
        /// <param name="to">Required parameter: Please enter multiple E164 number. You can add max 10 numbers. Add numbers separated with comma. e.g : +12223334444,+15556667777</param>
