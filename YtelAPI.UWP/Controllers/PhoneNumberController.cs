...
namespace YtelAPI.UWP.Controllers
{
    public partial class PhoneNumberController: BaseController
    {
        ...
        public string CreateBulkBuyNumbers(
                Models.NumberType2Enum numberType,
                string areaCode,
                string quantity,
                ...
                string leftover = null)
        {
            ...
            {
                new KeyValuePair<string, object>( "NumberType", Models.NumberType2EnumHelper.ToValue(numberType) ),
        ...
        public string CreateListNumbers(
                int? page = null,
                int? pageSize = null,
                Models.NumberTypeEnum? numberType = null,
                string friendlyName = null)
        {
                ...
                string friendlyName = null)
        {
            ...
            var _fields = new List<KeyValuePair<string, Object>>()
            {
                ...
                new KeyValuePair<string, object>( "NumberType", (numberType.HasValue) ? Models.NumberTypeEnumHelper.ToValue(numberType.Value) : null ),
                new KeyValuePair<string, object>( "FriendlyName", friendlyName )
            };
            //remove null parameters
            _fields = _fields.Where(kvp => kvp.Value != null).ToList();
        ...
        /// <return>Returns the string response from the API call</return>
        public string CreateReleaseNumber(string phoneNumber)
        {
            Task<string> t = CreateReleaseNumberAsync(phoneNumber);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="phoneNumber">Required parameter: A valid Ytel 10-digit phone number (E.164 format).</param>
        /// <return>Returns the string response from the API call</return>
        public async Task<string> CreateReleaseNumberAsync(string phoneNumber)
        {
            //the base uri for api requests
            string _baseUri = Configuration.BaseUri;
        ...
        /// <return>Returns the string response from the API call</return>
        public string CreateAvailableNumbers(Models.Numbertype1Enum numbertype, string areacode, int? pagesize = null)
        {
        ...
        /// <param name="pagesize">Optional parameter: The count of objects to return.</param>
        /// <return>Returns the string response from the API call</return>
        public async Task<string> CreateAvailableNumbersAsync(Models.Numbertype1Enum numbertype, string areacode, int? pagesize = null)
        {
            //the base uri for api requests
            string _baseUri = Configuration.BaseUri;
            ...
            var _fields = new List<KeyValuePair<string, Object>>()
            {
                new KeyValuePair<string, object>( "numbertype", Models.Numbertype1EnumHelper.ToValue(numbertype) ),
                new KeyValuePair<string, object>( "areacode", areacode ),
                new KeyValuePair<string, object>( "pagesize", pagesize )
            };
            //remove null parameters
