...
namespace YtelAPI.UWP.Controllers
{
    public partial class SMSController: BaseController
    {
        ...
        /// <param name="messageSid">Required parameter: The unique identifier for a sms message.</param>
        /// <return>Returns the string response from the API call</return>
        public string CreateViewSMSDetails(string messageSid)
        {
            Task<string> t = CreateViewSMSDetailsAsync(messageSid);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="messageSid">Required parameter: The unique identifier for a sms message.</param>
        /// <return>Returns the string response from the API call</return>
        public async Task<string> CreateViewSMSDetailsAsync(string messageSid)
        {
            //the base uri for api requests
            string _baseUri = Configuration.BaseUri;
