...
namespace YtelAPI.UWP.Models
{
    public class Body77 : BaseModel 
    {
        ...
        private Models.GroupConfirmFileEnum groupConfirmFile;
        ...
        public Models.GroupConfirmFileEnum GroupConfirmFile 
        { 
            get 
            {
        ...
        /// </summary>
        [JsonProperty("RecordCallBackMethod")]
        public string RecordCallBackMethod 
        { 
            get 
            {
